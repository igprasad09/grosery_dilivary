...
export const Cart = ({product_imf, product_img,}) => {
    const [count, setCount] = useState(0);
    const product = {
        name: product_imf.product_name,
        category: product_imf.category,
        price: product_imf.product_price,
        offerPrice: product_imf.offer_price,
        rating: 4,
        image: product_img,
    };
     
    return (
        <div className="border -ml-3 md:ml-0 scale-80 border-gray-500/20 rounded-md md:px-2 px-4  py-1 bg-white min-w-56 max-w-56 w-full">
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-end justify-between mt-3">
                    <p className="md:text-xl text-base font-medium text-emerald-500">
                        ${product.price} <span className="text-gray-500/60 md:text-sm text-xs line-through">${product.offerPrice}</span>
                    </p>
                    <div className="text-emerald-500">
                       <button className="flex cursor-pointer items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-[80px] w-[64px] h-[34px] rounded text-emerald-600 font-medium" >
